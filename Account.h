...
public:
   ...
   Account(std::string accountName, float initialBalance, float Interest)
   ...
   void withdraw (int withdrawAmount) {
       if (withdrawAmount < balance) {
           balance = balance - withdrawAmount; //subtract withdrawal from balance
       }
   }
